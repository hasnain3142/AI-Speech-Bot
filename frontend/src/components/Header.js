...
const Header = () => (
  <div className="text-center p-4 mt-16">
    <h1 className="text-8xl font-extralight mb-2 subpixel-antialiased text-yellow-100 text-pretty" style={{ fontFamily: 'Ubuntu, sans-serif' }}>
     Ask me anything about Garnier's latest shampoo and conditioner products!
    </h1>
    <h2 className="text-4xl font-thin subpixel-antialiased text-yellow-100 mt-16" style={{ fontFamily: 'Ubuntu, sans-serif' }}>
